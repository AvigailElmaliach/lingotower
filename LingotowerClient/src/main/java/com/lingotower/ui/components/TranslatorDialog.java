...
public class TranslatorDialog {
	...
	private static final String TRANSLATE_API_URL = "http://localhost:8080/api/translate/translate";
	...
	private static class TranslationRequest {
		...
		public TranslationRequest(String word, String sourceLang, String targetLang) {
			this.word = word;
