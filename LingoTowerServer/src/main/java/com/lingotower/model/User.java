...
public class User extends BaseUser {
	...
	@ManyToMany
	@JoinTable(name = "user_learned_words", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "word_id"))
	private List<Word> learnedWords = new ArrayList<>();

	public User() {
	}

	public User(String username, String password, String email, String sourceLanguage, String targetLanguage,
			Role role) {
