...
/**
 * AdminResponseDTO is a Data Transfer Object (DTO) class that returns data
 * about admin users. The purpose of this class is to return sensitive
 * information to the client without including the password or any other
 * sensitive data. The class contains the username, email, ID number, and role
 * of the user.
 * 
 */
