 ...
 * This class contains the details of the new admin along with the email of the current admin performing the registration.
 */
public class AdminRegisterRequest {
    ...
    /**
     * Default constructor (required for frameworks like Jackson for JSON object conversion).
     */
    public AdminRegisterRequest() {}

    /**
     * Constructs an admin registration request with the new admin's details and the current admin's email.
     *
     * @param adminCreateDTO An {@link AdminCreateDTO} object containing the new admin's details.
     * @param currentAdminEmail The email of the current admin performing the registration.
     */
