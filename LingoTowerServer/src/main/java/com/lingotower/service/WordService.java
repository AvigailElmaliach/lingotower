...
public class WordService {
	...
	public void addWordWithTranslation(WordDTO wordDTO, String targetLang) {
		...
		Word word = new Word(wordDTO.getWord(), translatedText, wordDTO.getLanguage());
	...
	public List<TranslationResponseDTO> getTranslatedWordsByCategory(Long categoryId, String sourceLang,
			String targetLang) {
...
//    }
	...
	public List<TranslationResponseDTO> getTranslatedWordsByCategoryAndDifficulty(Long categoryId,
			Difficulty difficulty, String sourceLang, String targetLang) {
		...
		// החזרת המילים עם התרגום שנשמר במאגר
		return words.stream().map(word -> new TranslationResponseDTO(word.getWord(), word.getTranslation()))
				.collect(Collectors.toList());
	}
	...
	public List<TranslationResponseDTO> getRandomTranslatedWordsByCategoryAndDifficulty(Long categoryId,
		...
		List<TranslationResponseDTO> translatedWords = getTranslatedWordsByCategoryAndDifficulty(categoryId, difficulty,
